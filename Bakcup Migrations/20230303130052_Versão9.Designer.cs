...
namespace CantinaDoTioBill.Migrations
{
    ...
    [Migration("20230303130052_Versão9")]
    partial class Versão9
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CantinaDoTioBill.Models.Rota", b =>
                {
                    b.HasOne("CantinaDoTioBill.Models.Cliente", "Cliente")
                        .WithMany()
            ...
            modelBuilder.Entity("CantinaDoTioBill.Models.Venda", b =>
                {
                    b.HasOne("CantinaDoTioBill.Models.Cliente", "IdCliente")
                        .WithMany()
                        .HasForeignKey("IdClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CantinaDoTioBill.Models.Cliente", "NomeCliente")
                        .WithMany()
